...
public class DispatchController extends HttpServlet {
    ...
    private final String HOME_PAGE_CONTROLLER = "ProductController";
    ...
    private final String VIEW_DETAIL_CONTROLLER="viewDetailController";
    private final String ADD_FORM_DETAIL_CONTROLLER="AddFromDetailController";
    private final String REMOVE_FROM_CART="RemoveController";
    private final String REGISTRATION_CONTROLLER="RegistrationController";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (button == null) {
                ...
                url=ADD_FORM_DETAIL_CONTROLLER;
